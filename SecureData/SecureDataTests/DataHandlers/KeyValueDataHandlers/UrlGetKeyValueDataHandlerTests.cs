...
{
    [TestClass()]
    public class UrlGetKeyValueDataHandlerTests
    {
        [TestMethod()]
        public void UrlGetKeyValueDataHandler_GetSecuredData_EmptySecuredProps_NonChangedResult()
        {
            //ARRANGE
            AbstractKeyValueDataHandler handler = new UrlGetKeyValueDataHandler();
        ...
        [TestMethod()]
        public void UrlGetKeyValueDataHandler_GetSecuredData_NonEmptySecuredProps_ParametresSecured()
        {
            //ARRANGE
            AbstractKeyValueDataHandler handler = new UrlGetKeyValueDataHandler();
            handler.Properties = new Dictionary<string, string>
        ...
        [TestMethod()]
        public void UrlGetKeyValueDataHandler_GetSecuredData_SecuredPropsNotInRequest_NonChangedResult()
        {
            //ARRANGE
            AbstractKeyValueDataHandler handler = new UrlGetKeyValueDataHandler();
            handler.Properties = new Dictionary<string, string>
